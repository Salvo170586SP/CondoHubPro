    ...
    <div class="container mx-auto relative h-full p-2 space-y-3">
        ...
        <div
            ...
            <div class="w-full flex gap-2">
                <div
                    class="my-3 shadow border border-zinc-400 w-[220px] text-slate-600 dark:text-white rounded-lg bg-slate-50 dark:bg-zinc-700 p-2">
                    <div class="font-medium flex justify-between items-center">
                        Totale Amministratori: <span
                            class="inline-flex ms-2 h-5 w-5 bg-black text-white rounded-lg justify-center items-center text-sm">{{ $administrators->count() }}</span>
                    </div>
                </div>
                <div
                    class="my-3 shadow border border-zinc-400 w-[220px] text-slate-600 rounded-lg dark:text-white bg-slate-50 dark:bg-zinc-700 p-2">
                    <div class="w-full font-medium flex justify-between items-center">
                        Totale Residenti: <span
                            class="inline-flex ms-2 h-5 w-5 bg-black  text-white rounded-lg justify-center items-center text-sm">{{ $residents->count() }}</span>
                    </div>
                </div>
                <div
                    class="my-3 shadow border border-zinc-400 w-[220px] text-slate-600 rounded-lg dark:text-white bg-slate-50 dark:bg-zinc-700  p-2">
                    <div class="font-medium flex justify-between items-center">
                        Totale Avvisi Bacheca: <span
                            class="inline-flex ms-2 h-5 w-5 bg-black text-white rounded-lg justify-center items-center text-sm">{{ $noticeBoards->count() }}</span>
                    </div>
                </div>
            </div>
