            ...
            <div class="h-full flex justify-between items-center">
                <div class="w-full h-full flex flex-col gap-1">
                    ...
                    <div class="border-b flex justify-between items-center  p-2">
                        <div>
                            <div class="font-medium text-xs capitalize text-zinc-500">{{ $diary->getYear($diary->date)
                                }}
                            </div>
                        ...
                        <div class="flex  gap-2">
                            ...
                            <flux:button icon="pencil" variant="filled" size="sm" wire:navigate
                                href="/admin/diary/{{$diary->id}}/edit" />
                    ...
                    <div class=" min-h-[600px] px-2 py-4">
                        ...
                        <p class="h-full text-zinc-500">{{$diary->content}}</p>
                    </div>
