<div>
    <div class="container mx-auto relative h-full flex-1 p-2">
        ...
        <div class="w-full flex justify-between items-center my-5">
            <h2 class="w-full text-xl font-medium">Archivio</h2>
        </div>
        ...
        <div class="w-full my-5 grid grid-cols-5 gap-2">
            ...
            @foreach ($condominiums as $condominium)
                <div wire:key="archiveCodn-{{ $condominium->id }}-{{ str()->random(10) }}"
                    class="max-w-[300px] h-[200px]">
                    <button wire:navigate href="/admin/archive/{{ $condominium->id }}/show"
                        class="w-full h-full rounded-lg border bg-zinc-50 hover:bg-zinc-100 cursor-pointer">
                        <div class="w-full h-[150px] flex justify-center items-center ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-30 text-zinc-600">
