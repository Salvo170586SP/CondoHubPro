        ...
        <div wire:key="notice-{{ $notice->id }}-{{ str()->random(10) }}"
            ...
            <div class="w-full font-semibold text-xs">
                @if ($notice->is_important)
                    <div class="flex justify-center items-center py-1 bg-red-100 border border-red-600 text-red-600 rounded-lg">
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                <div class="flex items-center gap-2">
                    <livewire:admin.noticesBoard.show-notices
                        wire:key="{{ $notice->id }}-{{ $condominium->id }}-{{ str()->random(10) }}"
                        :notice="$notice" :condominium="$condominium" />
