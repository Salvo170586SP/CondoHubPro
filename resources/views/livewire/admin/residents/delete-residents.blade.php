<div>
    ...
    <flux:modal name="delete-resident-[{{ $resident->id }}]" class="md:w-96 bg-white/80 backdrop-blur-lg">
        <div class="space-y-6">
            <div>
            ...
            <div class="flex">
                ...
                <div class="space-x-3">
                    ...
                    <flux:button type="submit" variant="danger" wire:click="deleteResident">Elimina
                    </flux:button>
                </div>
            </div>
        </div>
